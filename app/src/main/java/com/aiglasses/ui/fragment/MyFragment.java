...
import com.aiglasses.http.api.UpdateImageApi;
...
public final class MyFragment extends TitleBarFragment<HomeActivity> {
    ...
    /** 市 */
    private String mCity = "聊城市";
    /** 区 */
    private String mArea = "东昌府区";
    private String mID = "a9h7u54df";
    /** 头像地址 */
    ...
    protected void initData() {
        ...
        mIdView.setRightText("123456789");
        mNameView.setRightText("智能眼镜");
        ...
        ImageCropActivity.start(getAttachActivity(), sourceFile, 1, 1, new ImageCropActivity.OnCropListener() {
            ...
            public void onSucceed(Uri fileUri, String fileName) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    outputFile = new FileContentResolver(Objects.requireNonNull(getActivity()), fileUri, fileName);
                } else {
                    try {
